...
//        let urlRequest = URLRequest(url: reallyURL)
//
//        print(urlRequest)
//
//        //Add the username and password to URLCredential
//
//        let  credential = URLCredential(user:"3bdaccbd3e382000c5b44b0a3c582b5d", password:"07da17113c3f99d2be64a12fa6aa140d", persistence: .forSession)
//
