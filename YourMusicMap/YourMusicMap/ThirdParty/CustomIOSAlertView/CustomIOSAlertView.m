...
- (void)show
{
   ...
   self.backgroundColor = [UIColor colorWithRed:42/255.0 green:42/255.0 blue:42/255.0 alpha:0.85];
...
- (void)close
{
    ...
    [UIView animateWithDuration:0.2f delay:0.0 options:UIViewAnimationOptionTransitionNone
					 animations:^{
						 //self.backgroundColor = [UIColor colorWithRed:1 green:1 blue:1 alpha:0.9];
                         self.backgroundColor = [UIColor colorWithRed:42/255.0 green:42/255.0 blue:42/255.0 alpha:0.6];
