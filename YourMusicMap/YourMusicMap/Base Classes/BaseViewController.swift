...
public class BaseViewController : UIViewController,UIGestureRecognizerDelegate,SWRevealViewControllerDelegate{
...
//
//}
//extension BaseViewController:RequestingPopupViewControllerDelegate{
//    func createRequestingPopup(title:String,message:String)
//    {
//                self.popupAlertView = CustomIOSAlertView()
//                self.popupAlertView?.buttonTitles = nil
//                self.popupAlertView?.useMotionEffects = true
//                var demoView:UIView!
//                demoView = UIView()
//
//                let storyBoard: UIStoryboard = UIStoryboard(name: StoryboardName.Popups, bundle: nil)
//
//                if let vc = storyBoard.instantiateViewController(withIdentifier: ControllerIdentifier.RequestingPopupViewController as String)as? RequestingPopupViewController
//                {
//                    vc.delegate = self
...
//                    demoView.addSubview(vc.view)
//
//                    self.popupAlertView?.containerView = demoView
//                }
//
//    }
//    func actionCallBackDone() {
//        self.popupAlertView?.close()
//    }
//}
//extension BaseViewController:RatePopupDelegates{
//    func CreateRatePopup(title:String,message:String)
//    {
//        self.popupAlertView = CustomIOSAlertView()
//        self.popupAlertView?.buttonTitles = nil
//        self.popupAlertView?.useMotionEffects = true
...
//        let storyBoard: UIStoryboard = UIStoryboard(name: StoryboardName.Popups, bundle: nil)
//        
//        if let vc = storyBoard.instantiateViewController(withIdentifier: ControllerIdentifier.RatePopupViewController as String)as? RatePopupViewController
//        {
//            vc.delegate = self
//            //                    vc.messageTitle = title
//            //                    vc.message = message
//            self.objAlertVC = vc
//            demoView.frame = CGRect(x:0, y:0, width:300, height:200)
